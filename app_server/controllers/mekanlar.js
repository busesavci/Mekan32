...
if (process.env.NODE_ENV === 'production') {
  apiSecenekleri.sunucu = "https://mekan-32.herokuapp.com";
}
...
const anaSayfa=function(req,res){
  ...
  request(
    ...
    function(hata, cevap, mekanlar) {
      ...
      anaSayfaOlustur(req, res, cevap,gelenMekanlar,"mekanlar-liste","Mekan-32-Yakınındaki Mekanları Bul","Mekan-32","Yakınınızdaki Kafeleri, Restorantları Bulun!");
    } 
  );
}
